...
public class WinScreen implements Animation {
    ...
    /**
     * the screen that show when we finish and win the game.
     * @param d -- the DrawSurface.
     */
    @Override
    public void doOneFrame(DrawSurface d) {
        d.drawText(150, d.getHeight() / 2, "You Win! Your score is " + Integer.toString(this.scoreInTheEnd.getValue()),
                40);
